...
suffixes  <- c("Cbl", "Cbl_WM", "Cbl_GM", "vermis", "1-5", "6-7", "8-10")
names(suffixes) <- regions

sheet.names <- c("Cbl vol", "WM vol", "GM vol", "Vermis area", "I-V area", "VI-VII area", "VIII-X area")
names(sheet.names) <- regions
...
par(oma=c(0,0,1,2))
par(fig=c(0, 0.25, 0.45, 1))
funnel(results[[1]]$meta_SMD, main=regions[1], xlab=NA, ylab=NA, xlim=c(-1.2, 1.2), ylim=c(0.51, 0))
par(fig=c(0.25, 0.5, 0.45, 1), new=T)
funnel(results[[2]]$meta_SMD, main=regions[2], xlab=NA, ylab=NA, xlim=c(-1.2, 1.2), ylim=c(0.51, 0))
par(fig=c(0.5, 0.75, 0.45, 1), new=T)
funnel(results[[3]]$meta_SMD, main=regions[3], xlab=NA, ylab=NA, xlim=c(-1.2, 1.2), ylim=c(0.51, 0))
par(fig=c(0.75, 1, 0.45, 1), new=T)
funnel(results[[4]]$meta_SMD, main=paste(regions[4], "*"), xlab=NA, ylab=NA, xlim=c(-1.2, 1.2), ylim=c(0.51, 0))
par(fig=c(0, 0.25, 0, 0.55), new=T)
funnel(results[[5]]$meta_SMD, main=regions[5], xlim=c(-1.2, 1.2), ylim=c(0.51, 0))
par(fig=c(0.25, 0.5, 0, 0.55), new=T)
funnel(results[[6]]$meta_SMD, main=regions[6], xlab=NA, ylab=NA, xlim=c(-1.2, 1.2), ylim=c(0.51, 0))
par(fig=c(0.5, 0.75, 0, 0.55), new=T)
funnel(results[[7]]$meta_SMD, main=regions[7], xlab=NA, ylab=NA, xlim=c(-1.2, 1.2), ylim=c(0.51, 0))
par(op)
